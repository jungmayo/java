...
public class ExceptionTest {
	...
	public static void main(String[] args) {
		...
		try { //예외가 발생할 수 있는 코드
			r4 = num1 / num2; // num2 0으로 설정했을 때 에러, 0으로 나눌 수 없음
		}catch (ArithmeticException e) { //예외가 발생했을 때 처리되는 로직
		...
		//Animal ani = new Animal(); 해야 하는데
		Animal ani = null; //heap 영역에 null, 주소값 없어서 에러 발생
		try {
			ani.move();
